...
const features = [
  {
    ...
    description:
      'Our expertise lies in developing research solutions with a focus on technology.',
    icon: DeviceArrowIcon,
  },
  {
    name: 'Agile',
    description:'We are characterised by our swift thinking and actions, embodying speed, and agility in everything we do.',
    icon: DeviceCardsIcon,
  },
  {
    name: 'Futuristic',
    description:
      'Always looking ahead, we consistently innovate through the relentless adoption of cutting-edge tools and techniques.',
    ...
    >
      <Container>
        <div className="mx-auto max-w-2xl sm:text-center">
          ...
          We are a neuroscience and artificial intelligence based consumer research company
          </h2>
