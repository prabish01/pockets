    ...
    >
      <Container>
        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-3xl">
          ...
          Changing each lives with technological research

          </h2>
          <p className="mt-2 text-lg text-gray-400">
          An independent medical research institute committed to enhancing the well-being of individuals affected by brain and nervous system disorders.
